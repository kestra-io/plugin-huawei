...
public interface EventGridConnectionInterface extends AbstractConnectionInterface {

    @Schema(
        title = "EventGrid endpoint URL override",
        description = """
    ...
    @Schema(
        ...
        description = """
            Controls the top-level domain used when deriving the EventGrid endpoint from `region`.
