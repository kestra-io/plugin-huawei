...
public interface DliConnectionInterface extends AbstractConnectionInterface {

    @Schema(
        title = "DLI endpoint URL override",
        description = """
    ...
    @Schema(
        ...
        description = """
            Controls the top-level domain used when deriving the DLI endpoint from `region`.
