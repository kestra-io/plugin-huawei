...
public interface SmnConnectionInterface extends AbstractConnectionInterface {

    @Schema(
        title = "SMN endpoint URL override",
        description = """
    ...
    @Schema(
        ...
        description = """
            Controls the top-level domain used when deriving the SMN endpoint from `region`.
