...
/**
 * Key/value serialization type for DMS Kafka messages.
 *
 * <p>All values are stored as {@code byte[]} in the wire frame; this enum drives the
 * encode/decode logic applied in {@link Produce} and {@link Consume}.
 */
