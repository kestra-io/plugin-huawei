...
public class KooCLI extends AbstractExecScript implements RunnableTask<ScriptOutput>, AbstractConnectionInterface {
    ...
    private Map<String, String> buildEnv(
        ...
        var rEnv = runContext.render(this.getEnv()).asMap(String.class, String.class);
